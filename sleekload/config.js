...
config.music_playlist = [
	{
		name: "Volbeat - Still Counting.",
		file: "Volbeat_-_Still_Counting_Guitar_Ga_(getmp3.pro)(1).ogg",
	},
]
...
config.messages_list = [
	"Welcome to CrackHouseRP!",
	"I hope you enjoy your stay!",
	"Make sure to join the discord",
	"discord.gg/N6qzXG9Fqk",
]
